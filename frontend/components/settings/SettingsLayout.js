...
export default function SettingsLayout({ nav, children }) {
  return (
    <PageSplit className="mx-auto w-full max-w-[1440px] px-2 xl:px-0" columnsClassName="sm:grid-cols-[320px_minmax(0,1fr)]" gapClassName="gap-7">
      <PageAside stickyTopClassName="sm:top-[96px]">
