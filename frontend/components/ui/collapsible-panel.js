    ...
    >
      <summary className="flex cursor-pointer list-none items-start justify-between gap-4 px-5 py-4">
        ...
        <div className="flex shrink-0 items-center gap-2">
          {action}
          <span className="rounded-full border border-[#d0d5dd] bg-white px-2.5 py-1 text-[11px] font-semibold text-[#475467] transition group-open:bg-[#101828] group-open:text-white">
